      ...
      let html = `
          <div class="group relative block overflow-hidden ">
              ...
              <div class="relative border border-gray-100 bg-white p-6">
                  ...
                  <h3 class="mt-4 text-lg font-medium text-gray-900"> ${this.props.title} </h3>
                  <p class="mt-1.5 text-sm text-gray-700">$ ${this.props.price}</p>
                  <button class="addItemToCart mt-4 block w-full rounded bg-yellow-400 p-4 text-sm font-medium transition hover:scale-105">
                      Add to Cart
                  </button>
              </div>
          </div>
